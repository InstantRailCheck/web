        ...
        <div className="mt-8 space-y-10 text-sm leading-relaxed text-slate-300">
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-1.5 pl-5">
              ...
              <li>
                <strong className="text-slate-100">P2P - Zelle</strong> — checked against Zelle&apos;s own
                partner directory, which is confirmed to be incomplete (a genuine Zelle-supporting
                bank can be absent from it). A missing badge means &quot;not listed,&quot; not
