    ...
    <main id="main-content" className="min-h-screen bg-slate-950 text-white">
      <div className="mx-auto flex w-full max-w-4xl flex-col px-6 pt-10 pb-16">
        <div className="mx-auto w-full max-w-3xl">
          ...
          <p className="mt-1 text-center text-sm text-slate-400">Last updated July 14, 2026.</p>
          ...
          <div className="mt-8 space-y-8 text-sm leading-relaxed text-slate-300">
            <section>
              ...
              <p className="mt-2">
                ...
                compatibility — which payment rails (RTP, FedNow, ACH, Wire, P2P - Zelle, and others)
            ...
            <section>
              ...
              <p className="mt-2">
                Signing in requires a real email address (via Google, GitHub, Microsoft, or a
                one-time code) or a passkey tied to a real account — no anonymous submissions. Route reports
